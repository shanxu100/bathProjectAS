...
import luluteam.bath.bathprojectas.video.other.MyOrientationDetector;
import luluteam.bath.bathprojectas.video.other.WindowSizeChangeNotifier;
 ...
 * 只是页面的方向是手动控制的
 */
public class PlayActivity2 extends Activity implements View.OnClickListener, WindowSizeChangeNotifier.OnWindowSizeChangedListener
        , EZUIPlayer.EZUIPlayerCallBack, MyOrientationDetector.OnChangeOrientationListener {
    ...
    public static void startPlayActivity(Context context, String appkey, String accesstoken, String url) {
        ...
        Intent intent = new Intent(context, PlayActivity2.class);
...
//        setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_SENSOR);
        ...
        mOrientationDetector.setListener(this);
        ...
        btn_fullScreen.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mOrientationDetector.isWideScrren()) {
...
//                    setSurfaceSize();
     ...
     * 手动设置横屏还是竖屏
     */
//    private void setSurfaceSizeManually(boolean isWideScrren) {
//        DisplayMetrics dm = new DisplayMetrics();
//        getWindowManager().getDefaultDisplay().getMetrics(dm);
//        //竖屏
//        if (!isWideScrren) {
