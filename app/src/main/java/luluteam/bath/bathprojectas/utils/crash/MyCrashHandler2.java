...
public class MyCrashHandler2 implements Thread.UncaughtExceptionHandler {
    ...
    //采集AppCrash信息
    public static final String COLLECT_CRASH = "http://121.199.23.184:8082/bathProject" + "/debug/collectCrash";
...
//        System.out.println("catch it----------------------------------");
     ...
     * @param context
     */
    public void collectDeviceInfo(Context context, CrashInfoResult.CrashItem item) {
        try {
